package com.example.liveglass.util;
...
public abstract class SystemUiHider {
	 ...
	 */
	public static com.example.liveglass.util.SystemUiHiderHoneycomb getInstance(Activity activity, View anchorView,
			int flags) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			return new SystemUiHiderHoneycomb(activity, anchorView, flags);
		} else {
			return new com.example.liveglass.util.SystemUiHiderHoneycomb(activity, anchorView, flags);
		}
	}
